...
Npt_l    = 30;           % points
Npt_u    = 30;           % pints
Npt_step =10;             % length of the step - layers
...
%filename = 'dielectric_overhang_relief_trapezoid_half_h_DM_FFF_complete.m_TM_DM_1percent.mat';
filename = 'dielectric_overhang_relief_trapezoid_half_h_DM_FFF_complete.m_TM_DM_1percent_N=101_L=10_Npt=30.mat';
save(filename)
RPvec
RP_ref
TPvec
