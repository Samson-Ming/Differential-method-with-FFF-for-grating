...
%filename = 'Metal_overhang_relief_sinusodial_0.5h_Phi=60_TM_1percent_DM.mat';
%filename = 'Metal_overhang_relief_sinusodial_0.5h_Phi=60_TM_1percent_DM_N=121_L=50_Npoint=120.mat';
filename = 'Near_field_Metal_overhang_relief_sinusodial_0.5h_Phi=60_TM_1percent_DM_N=121_L=50_Npoint=120.mat';
save(filename)
RP
RP_ref